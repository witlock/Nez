...
namespace Nez.UI
{
    public class ChatText : Label
    {
        ...
        public ChatText(string text, LabelStyle style) : base(text, style)
        {
            setStyle(style);
            setText(text);
        ...
        public ChatText(string text, BitmapFont font, Color fontColor) : this(text, new LabelStyle(font, fontColor))
        { }


        public ChatText(string text, BitmapFont font) : this(text, font, Color.White)
        { }
